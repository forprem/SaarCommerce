...
import com.pulsaar.saarcommerce.model.Products;
...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productImg = (ImageView) findViewById(R.id.product_image_details);
        ...
        addToCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (state.equals("Order Placed") || state.equals("Order Shipped")) {
                    Toast.makeText(ProductDetailsActivity.this, "You can purchase more products once it is shipped or confirmed", Toast.LENGTH_SHORT).show();
                } else {
                    addingToCartList();
                }
            }
    ...
    public void addingToCartList() {
            ...
            cartListRef.child("User View").child(PaperCache.currentOnlineUser.getPhone())
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                cartListRef.child("Admin View").child(PaperCache.currentOnlineUser.getPhone())
                                        .child("Products").child(productID)
                                        .updateChildren(cartMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
